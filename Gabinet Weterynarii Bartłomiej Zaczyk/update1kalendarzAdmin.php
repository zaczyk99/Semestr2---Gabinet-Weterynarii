...
<div id="panel">
<center> 
<h2> Aktualizacje Wydarzenia </h2>
Uwaga: Wszystkie pola są obowiązkowe
</br>
<form action="updateDzien.php" method="post">

	<input type="text" name="data" placeholder="Podaj date: " required/> <br>
	<input type="text" name="zajecie" placeholder="Podaj wydarzenie: " required/> <br>
