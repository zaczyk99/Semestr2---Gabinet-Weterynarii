...
<form action="usunDzien.php" method="post">
	<input type="text" name="data" placeholder="Podaj datę do usunięcia " required/> <br>

<button type="submit"> Usun wybrany wiersz.</button>
