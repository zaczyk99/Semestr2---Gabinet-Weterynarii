<?php
	...
	{
		header('Location: Salon Weterynarii Admina.php');
		exit();
	}
	if (isset($_SESSION['zalogowanyPracownik']))
	{
		header('Location: Salon Weterynarii Pracownika.php');
		exit();
	}
?>
...
<style>
  ...
  <body>
    ...
    <ol>
	<li><a href="Salon weterynarii.php">Strona domowa</a></li>
      <li><a href="#">Strony</a>
        <ul>
  ...
  <li><a href="pracownicy.php">Nasi pracownicy</a></li>
		  ...
		  <li><a href="zarzadzanie.php">Dodaj</a></li>
      </li>
