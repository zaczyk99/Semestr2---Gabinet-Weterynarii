...
<div id="panel">
<center> 
<h2> Aktualizacje Pracownika </h2>
Uwaga: Wszystkie pola są obowiązkowe
</br>
<form action="updatePracownika.php" method="post">
	...
	<input type="text" name="wiek" placeholder="Podaj wiek: " required/> <br>
	<input type="text" name="plec" placeholder="Podaj plec: " required/> <br>
	<input type="text" name="rodzaj_zatrudnienia" placeholder="Podaj rodzaj zatrudnienia: " required/> <br>
	<input type="text" name="telefon" placeholder="Podaj telefon: " required/> <br>
	<input type="text" name="adres_korespondencyjny" placeholder="Podaj adres korespondecyjny: " required/> <br>
	<input type="text" name="adres_email" placeholder="Podaj adres email: " required/> <br>
	<input type="text" name="stanowisko" placeholder="Podaj stanowisko: " required/> <br>
